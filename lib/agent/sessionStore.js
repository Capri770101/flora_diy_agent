...
function createSession() {
  return { session_id: uid('ses'), requirements: null, history: [], created_at: new Date().toISOString() };
}
...
function isSame(prev, next) {
  ...
  const keys = [...SCALAR_FIELDS, ...ARRAY_FIELDS, 'avoid_allergen'];
  for (const k of keys) {
...
module.exports = { createSession, mergeRequirements, pushPlan, diffVersions, isSame, latestPlan, SCALAR_FIELDS, ARRAY_FIELDS };
